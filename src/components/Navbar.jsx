...
return (
   ...
   <nav id="navbar" class=" bg-[#151218] flex justify-between w-full items-center py-2 px-4 fixed transition duration-700 ease-in-out z-30 bg-opacity-70">
    <a href="#">
        <h1 class="text-3xl text-slate-300">Clever Books</h1>
    </a>
    <div class=" hidden md:flex gap-6  ">
        <a href="" class="text-slate-300 hover:text-red-300 transition duration-150">Product</a>
        <a href="" class="text-slate-300 hover:text-red-300 transition duration-150">Pricing</a>
        <a href="" class="text-slate-300 hover:text-red-300 transition duration-150">Industry</a>
        <a href="" class="text-slate-300 hover:text-red-300 transition duration-150">Coustomer Stories</a>
        <a href="" class="text-slate-300 hover:text-red-300 transition duration-150">About</a>
        <a href="" class="text-slate-300 hover:text-red-300 transition duration-150">Blog</a>
    </div>
    <div class=" hidden md:flex justify-between items-center gap-[1.5rem]">
        <button className="text-rose-500 hover:text-white transition duration-150">Login</button>
